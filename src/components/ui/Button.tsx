...
const Button = ({
  ...
  const variantStyles = {
    primary:
      'bg-gradient-to-r from-brand-500 to-cyan-500 text-white hover:from-brand-600 hover:to-cyan-600 focus:ring-brand-500/20 shadow-md',
    ...
    danger:
      'bg-gradient-to-r from-error-500 to-error-600 text-white hover:from-error-600 hover:to-error-700 focus:ring-error-500/20 shadow-md',
  };
