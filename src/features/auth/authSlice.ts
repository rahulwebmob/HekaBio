...
// Mock Users Database - Updated for simplified role structure
export const MOCK_USERS: User[] = [
  ...
  {
    id: 'user-5',
    email: 'dd.specialist@hekabio.com',
    firstName: 'Dr. Lisa',
    lastName: 'Kumar',
    fullName: 'Dr. Lisa Kumar',
    role: 'dd_specialist' as UserRole,
    isActive: true,
    createdAt: '2024-01-01T00:00:00Z',
    organization: 'HekaBio',
  ...
  {
    id: 'user-6',
    email: 'dd.specialist2@hekabio.com',
    firstName: 'James',
    lastName: 'Martinez',
